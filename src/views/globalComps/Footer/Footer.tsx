      ...
      <div className={styles.container}>
        <div>
          <ul>
            ...
            <li>
              <a className={styles.Linka} href="#contact">
                Contact
              </a>
            </li>
            <li>
              <a className={styles.Linka} href="#projects">
                Projects
              </a>
            </li>
            <li>
              <a className={styles.Linka} href="#about">
                About
              </a>
            </li>
          </ul>
        ...
        <div>
          <ul>
            ...
            <li>
              <a className={styles.Linka} href="tel:+2348108850572">
                <AiFillPhone size={15} />
