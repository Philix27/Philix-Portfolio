            ...
            <div >
                ...
                <div>
                    ...
                    <div className='sectionText'>
                        <ul >
                            ...
                            <li className='techList'>DELSUTH Oghara, Delta State: 2019 - 2020 </li>
                            <li className='techList'>General Hospital Zauro, Kebbi State: 2021 - 2022 </li>
                    </ul>
                    </div>
                </div>
                <div>
                    ...
                    <div className='sectionText'>
                        <ul>
                            <li className='techList'>
                                Avaliability of Antibiotics as OTC
                                in community Pharcies in Delta State -
                                Undergraduate  </li>
                    </ul>
                    </div>
                </div>                
                <div>
                    ...
                    <div className='sectionText'>
                        <ul>
                            <li className='techList'>
                                Rxedu - Pharmacy Learning Platform
                                - Collaboration with Pharm Austine Odibo
                            </li>
                            <li className='techList'>
                                Pharmahub - Pharmacy Questions and Answer Forum -
                                Collaboration with Pharm Austine Odibo  
